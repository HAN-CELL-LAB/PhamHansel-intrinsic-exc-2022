...
\begin{itemize}
    ...
    \item
    \NEWCHANGE{A potential problem arising from this shared amplification
        is that it may reduce the ability to discriminate
        between different input patterns.}
    \item
    \NEWCHANGE{Here, we assess the performance of an artificial neural network
    ...
    \item
    \NEWCHANGE{We observe that negative changes in threshold potentials
    ...
    \item
    \NEWCHANGE{Analysis of whole-cell patch-clamp recordings from pyramidal neurons
