\begin{figure}[H]
    ...
    Distribution of S1 recordings
        ...
        \TOREMOVE{See text and {\autoref{supp:s1-data-dV_TR}} for more information.}
    \FIGNEWNOTE{
        Re-generated panel a with V1, adjusted y-axis limit of dVTR so that the ``widths'' of the distributions can be easily compared, also same with panel b with S1.
        Integrated new data in b, d, e, new range in c.
        Changed title of panel b, removed citation.
        Unclear whether to say ``S1 in vitro (Gill \& Hansel 2020 + additional)''
    }
    }
