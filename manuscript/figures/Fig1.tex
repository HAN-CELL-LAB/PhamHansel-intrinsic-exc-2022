...
\begin{figure}[ht]
    ...
    \TOREMOVE{These are shown for the best states,
        see {\autoref{supp:discrim-dist-full}} for comparison with the initial states.}
    \FIGNEWNOTE{added ``scale'' for panel b distance arrow.}
    }
    \label{fig:discrim}
\end{figure}