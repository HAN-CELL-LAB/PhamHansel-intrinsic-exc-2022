\begin{figure}[!ht]
    ...
    \FIGNEWNOTE{added the ROC from supp as panel b. Swishing to a would not look so ``balanced''. Pushed the colorbars of panel a in the middle to fit. Added a title for the demo panel c.Removed d2 ylabels to fit, since they share with d1.}
    }
